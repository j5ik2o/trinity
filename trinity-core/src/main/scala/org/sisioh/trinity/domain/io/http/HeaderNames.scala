...
//  val AcceptRanges = Value(Names.ACCEPT_RANGES)
//  val AcceptPatch = Value(Names.ACCEPT_PATCH)
//
//  val AccessControlAllowCredentials = Value(Names.ACCESS_CONTROL_ALLOW_CREDENTIALS)
//  val AccessControlAllowHeaders = Value(Names.ACCESS_CONTROL_ALLOW_HEADERS)
//  val AccessControlAllowMethods = Value(Names.ACCESS_CONTROL_ALLOW_METHODS)
//  val AccessControlAllowOrigin = Value(Names.ACCESS_CONTROL_ALLOW_ORIGIN)
//  val AccessControlExposeHeaders = Value(Names.ACCESS_CONTROL_EXPOSE_HEADERS)
//  val AccessControlMaxAge = Value(Names.ACCESS_CONTROL_MAX_AGE)
//  val AccessControlRequestHeaders = Value(Names.ACCESS_CONTROL_REQUEST_HEADERS)
//  val AccessControlRequestMethod = Value(Names.ACCESS_CONTROL_REQUEST_METHOD)
//
//  val Age = Value(Names.AGE)
//  val Allow = Value(Names.ALLOW)
//  val Authorization = Value(Names.AUTHORIZATION)
