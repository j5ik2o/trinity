...
import org.jboss.netty.buffer.{ChannelBuffers => NettyChannelBuffers, ChannelBuffer => NettyChannelBuffer}
import org.sisioh.trinity.domain.infrastructure.netty3.buffer.ChannelBuffersImpl
