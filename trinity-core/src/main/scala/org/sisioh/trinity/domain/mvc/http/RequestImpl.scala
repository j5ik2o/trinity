...
(val underlying: http.Request,
 ...
 val errorOpt: Option[Throwable])
  ...
  def this(method: Method.Value,
    ...
    this(http.Request(httpVersion, method, uri), actionOpt, routeParams, globalSettingsOpt, errorOpt)

  def params: ParamMap = underlying.params
  ...
  def fileExtension = underlying.fileExtension
